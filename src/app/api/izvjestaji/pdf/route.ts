...
// generateFinancialReportPdf runs several aggregate reports before rendering the PDF —
// can be tight for a larger ZEV against a platform's default (e.g. Vercel's 10s). No-op
// on Docker; respected on Vercel (Plans/deployment-portability-plan.md §8.4).
