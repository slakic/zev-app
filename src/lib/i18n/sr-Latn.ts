...
const srLatn = {
  ...
  live: {
    ...
    tabRollCall: "Prozivka",
    tabAgenda: "Dnevni red",
    discussionOnly: "Diskusija — bez prijedloga za glasanje.",
    proposalText: "Tekst prijedloga",
    openVotingTrigger: "Otvori glasanje",
    openVotingTitle: "Otvaranje glasanja je nepovratno",
    openVotingConfirm: "Da, otvori glasanje",
    previewInRoom: "U sali (glasaju ručno)",
    previewEmail: "Dobiće e-mail",
    previewNoChannel: "Bez ikakvog kanala",
    previewNoChannelHint: "ostaju u glasačkoj bazi i računaju se u kvorum",
    quorumUnreachable: "Zbir težina u sali i onih koji dobijaju e-mail ne dostiže kvorum.",
    voteFor: "Za",
    voteAgainst: "Protiv",
    voteAbstain: "Uzdržan",
    resultQuorumReached: "Kvorum postignut",
    resultQuorumNotReached: "Kvorum NIJE postignut",
    resultOutcomeIfClosedNow: "Ishod ako se sada zatvori",
    resultAccepted: "USVOJENO",
    resultNotAccepted: "NIJE USVOJENO",
    manualEntryTitle: "Unos iz sale",
    manualEntryRemaining: "Ostalo",
    electronicTitle: "Glasali elektronski",
    noChannelTitle: "Bez kanala",
    paperEntryHint: "Naknadni papirni unos",
    closeVotingTrigger: "Zatvori glasanje",
    closeVotingTitle: "Zatvaranje glasanja je nepovratno",
    ...
    refreshNow: "Osvježi",
    markViaProxy: "Punomoćnik",
    proxyLabel: "Punomoćnik",
    markRestAbsentTrigger: "Označi sve neoznačene kao odsutne",
    markRestAbsentTitle: "Masovno označavanje odsutnih",
    markRestAbsentBodyPrefix: "Označiće se",
    markRestAbsentBodySuffix: "lica kao odsutna.",
    markRestAbsentConfirm: "Da, označi kao odsutne",
    bulkApproveTrigger: "Svi preostali prisutni: Za",
    bulkApproveTitle: "Masovni unos glasova je nepovratan",
    bulkApproveBody: "Za sljedeće osobe u sali biće evidentiran glas „Za“",
    bulkApproveConfirm: "Da, evidentiraj glasove „Za“",
    pendingElectronicTitle: "Čeka se elektronski glas",
    notifyQueued: "U redu čekanja",
    notifySent: "Poslato",
    notifyDelivered: "Isporučeno",
    notifySeen: "Pročitano",
    notifyFailed: "Neuspješno",
    notifyFailedWarning: "Jedna ili više e-mail poruka za ovu tačku nije uspješno isporučena.",
  },
  eVoteConsentStatus: {
    NONE: "Nije pokrenuto",
